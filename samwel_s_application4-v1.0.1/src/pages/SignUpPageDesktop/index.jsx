    ...
    <>
      <div className="bg-gray-900 flex flex-col font-lexend sm:gap-10 md:gap-10 gap-[137px] items-center justify-end mx-auto pt-[50px] w-full">
        <div className="flex flex-col items-center justify-start max-w-[1596px] mx-auto md:px-5 w-full">
          ...
          <div
            className="bg-cover bg-gray-900_01 bg-no-repeat border border-gray-900_02 border-solid h-[928px] mt-[53px] md:px-10 sm:px-5 px-[150px] py-[100px] relative rounded-[20px] w-[1326px] md:w-full"
          ...
          >
                  ...
                  <div className="flex flex-col gap-[30px] items-center justify-start w-full">
                    ...
                    <div className="flex sm:flex-col flex-row gap-[30px] items-center justify-start w-full">
                      ...
                      <Input
                        ...
                        suffix={
                          <Img
                            className="mt-auto mb-px h-6 ml-3"
            ...
            <Img
              className="absolute h-[342px] object-cover right-[16%] top-[11%] w-[325px] md:w-full"
...
export default SignUpPageDesktopPage;
